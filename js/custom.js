...
const updatePlateau = () => {
  let date_tab = [
    { 'status': '', 'day_num': 1, 'day_date': '2021/05/20' },
    { 'status': '', 'day_num': 2, 'day_date': '2021/05/21' },
    { 'status': '', 'day_num': 3, 'day_date': '2021/05/22' },
    { 'status': '', 'day_num': 4, 'day_date': '2021/05/24' },
    { 'status': '', 'day_num': 5, 'day_date': '2021/05/25' },
    { 'status': '', 'day_num': 6, 'day_date': '2021/05/26' },
    { 'status': '', 'day_num': 7, 'day_date': '2021/05/27' },
    { 'status': '', 'day_num': 8, 'day_date': '2021/05/28' },
    { 'status': '', 'day_num': 9, 'day_date': '2021/05/29' },
    { 'status': '', 'day_num': 10, 'day_date': '2021/05/31' },
  ];
