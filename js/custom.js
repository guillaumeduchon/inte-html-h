...
const updatePlateau = () => {
  let date_tab = [
    {'status':'','day_num': 1, 'day_date':'2021/01/25'},
    {'status':'','day_num': 2, 'day_date':'2021/01/25'},
    {'status':'','day_num': 3, 'day_date':'2021/01/25'},
    {'status':'','day_num': 4, 'day_date':'2021/01/25'},
    {'status':'','day_num': 5, 'day_date':'2021/01/25'},
    {'status':'','day_num': 6, 'day_date':'2021/01/25'},
    {'status':'','day_num': 7, 'day_date':'2021/01/25'},
    {'status':'','day_num': 8, 'day_date':'2021/01/25'},
    {'status':'','day_num': 9, 'day_date':'2021/01/25'},
    {'status':'','day_num': 10, 'day_date':'2021/01/25'},
  ];
