...
const updatePlateau = () => {
  let date_tab = [
    ...
    {'status':'','day_num': 6, 'day_date':'12/01/2021'},
    {'status':'','day_num': 7, 'day_date':'13/01/2021'},
    {'status':'','day_num': 8, 'day_date':'14/01/2021'},
    {'status':'','day_num': 9, 'day_date':'15/01/2021'},
    {'status':'','day_num': 10, 'day_date':'16/01/2021'},
  ];
